...
const ProfileRepairBillsComponent = () => {
  ...
  const fetchBills = async () => {
    ...
    const resp = await RepairBillDataService.findNewUserBills(state.pageNumber, state.pageSize, state.sortBy, state.sortDirection).catch((err) => {
      notification.error({
  ...
  const payBill = async (id) => {
    ...
    const resp = await RepairBillDataService.payBill(id).catch((err) => {
      notification.error({
...
export default ProfileRepairBillsComponent
