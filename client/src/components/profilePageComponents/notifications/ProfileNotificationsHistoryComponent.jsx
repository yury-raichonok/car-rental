...
const ProfileNotificationsHistoryComponent = () => {
  ...
  const fetchNotifications = async () => {
    ...
    const resp = await NotificationDataService.findNotificationsHistory(state.pageNumber, state.pageSize, state.sortBy, state.sortDirection).catch((err) => {
      notification.error({
...
export default ProfileNotificationsHistoryComponent
