...
public interface RepairBillMapper {
  ...
  @Mapping(target = "sentDate", source = "repairBill.sentDate", dateFormat = REPAIR_BILL_DATE_FORMAT_PATTERN)
  ...
  @Mapping(target = "paymentDate", source = "repairBill.paymentDate", nullValueCheckStrategy = NullValueCheckStrategy.ALWAYS, dateFormat = BILL_DATE_FORMAT_PATTERN)
